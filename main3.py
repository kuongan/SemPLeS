...
from engine3 import train_one_epoch, evaluate, generate_attention_maps_ms
import models123
import utils
import random
import numpy as np
...
def get_args_parser():
    ...
    parser.add_argument('--btp_path', default='', help='resume from checkpoint')
...
def main(args):
    ...
    btp.load_state_dict(torch.load(args.btp_path, map_location='cpu'))
    btp.eval()
